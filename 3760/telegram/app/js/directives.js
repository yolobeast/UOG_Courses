...
angular.module('myApp.directives', ['myApp.filters'])
  ...
  .directive('myTitleForm', function (_,$timeout, $compile, AppStickersManager, AppDocsManager,AppChatsManager) {
