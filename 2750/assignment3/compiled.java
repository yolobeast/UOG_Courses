...
public class compiled
{
	...
	{	
		try{
			...
			if(gen.parseFrom_PM(file.getName())==0)
			{
			  return(0);
			}
			else
			...
			String yolobeast = buttonzz[buttonzz.length-1];  
			gen = new JNIwrapper();
			...
			PrintWriter interfacewritter = new PrintWriter(new BufferedWriter(new FileWriter(fp.getPath()+"/"+gen.getstring(yolobeast)+".java")));
			...
			interfacewritter.println("public class "+gen.getstring(yolobeast)+" implements ActionListener");
			interfacewritter.println("{");
			interfacewritter.println("\t"+cl+"FieldEdit d;");
			interfacewritter.println("\tpublic "+gen.getstring(yolobeast)+"("+cl+"FieldEdit d)");
			interfacewritter.println("\t{");
			interfacewritter.println("\t\tthis.d = d;");
			interfacewritter.println("\t}");
			...
			for(String x : string)
			{
			  interfacewritter.println("\t\t\td.getDC"+x+"();");
			}
			interfacewritter.println("\t\t\td.appendToStatusArea"+"(\"button pressed\");");
			interfacewritter.println("\t\t}");
			interfacewritter.println("\t\tcatch(Exception tr)");
			interfacewritter.println("\t\t{");
			interfacewritter.println("\t\td.appendToStatusArea"+"(\"ERROR\");");
			interfacewritter.println("\t\t}");
			interfacewritter.println("\t}");
			interfacewritter.println("}");
