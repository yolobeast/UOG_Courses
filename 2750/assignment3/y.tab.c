...
static const yytype_uint8 yyprhs[] =
{
      ...
      24,    28,    32,    37,    41,    47,    52
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      14,     0,    -1,    14,    16,    -1,    16,    -1,     9,    -1,
      10,    -1,    11,    -1,    12,    -1,    10,     3,    17,    -1,
      11,     3,    18,    -1,    12,     3,    18,    -1,     9,     3,
      17,    -1,     5,    15,     5,     4,    -1,     6,    19,     4,
      -1,     5,    15,     5,     8,    19,    -1,     5,    15,     5,
       7,    -1,     7,    -1
};
...
static const char *const yytname[] =
{
  ...
  "$accept", "stmnt", "string", "assign", "expr", "listexpr", "listitem", 0
};
#endif
...
#line 84 "yadc.y"
    {
				    setTable(tablevalues,(yyvsp[(1) - (3)].sval),(yyvsp[(3) - (3)].sval));
			   }
    break;
...
#line 92 "yadc.y"
    { if(buff==NULL)
				    ...
				    strcpy(buff->b[buff->temp],(yyvsp[(2) - (5)].sval));
				   // buff->listthings++;
				    buff->index++;
				    buff->temp++;
...
#line 104 "yadc.y"
    {  if(buff==NULL)
				    ...
				    strcpy(buff->b[buff->temp],(yyvsp[(2) - (4)].sval));
				    //buff->listthings++;
				    buff->index++;
				    buff->temp++;
				    //list_add_element(buff,$1);
